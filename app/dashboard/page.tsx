...
import { Plus, FileText, Eye, Edit, Trash2, Crown, Building2 } from "lucide-react"
import { useRouter } from "next/navigation"
import { useCompany } from "@/contexts/company-context"

export default function DashboardPage() {
  const { invoices, deleteInvoice } = useInvoice()
  const { canCreateInvoice, currentPlan, invoicesThisMonth, monthlyLimit } = usePlan()
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage your invoices and track your business</p>
            </div>
            <Button
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {invoicesThisMonth}
                  {currentPlan === "free" && <span className="text-sm font-normal text-gray-500">/{monthlyLimit}</span>}
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Complete your company setup</h3>
                      <p className="text-gray-600">
                        Add your company information and logo to create professional invoices
                      </p>
                    </div>
                  </div>
                  <Link href="/company-settings">
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white">Setup Company</Button>
                  </Link>
                </div>
              </CardContent>
            </Card>
            ...
            <CardHeader>
              ...
              <CardDescription>
                {invoices.length === 0
                  ...
                  : `You have ${invoices.length} invoice${invoices.length !== 1 ? "s" : ""} total.`}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {invoices.length === 0 ? (
        ...
        <Dialog open={showUpgradeModal} onOpenChange={setShowUpgradeModal}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                You've reached your monthly limit of {monthlyLimit} invoices. Upgrade to unlimited to create more
                invoices.
              </DialogDescription>
            </DialogHeader>
